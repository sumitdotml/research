...
**Author:** Neel Nanda
**Date:** May 12, 2025
**Source:** [LessWrong](https://www.lesswrong.com/posts/eJGptPbbFPZGLpjsp/highly-opinionated-advice-on-how-to-write-ml-papers)
...
- [The Essence of a Paper](#the-essence-of-a-paper)
  - [Crafting a Narrative](#crafting-a-narrative)
  - [When to Start?](#when-to-start)
  - [Novelty](#novelty)
  - [Rigorous Supporting Evidence](#rigorous-supporting-evidence)
  - [Paper Structure Summary](#paper-structure-summary)
- [Analysing My Grokking Work](#analysing-my-grokking-work)
- [The Writing Process: Compress then Iteratively Expand](#the-writing-process-compress-then-iteratively-expand)
  - [Compress](#compress)
  - [Iteratively Expand](#iteratively-expand)
- [The Anatomy of a Paper](#the-anatomy-of-a-paper)
  - [Abstract](#abstract)
  - [Introduction](#introduction-1)
  - [Figures](#figures)
  - [Main Body (Background, Methods and Results)](#main-body-background-methods-and-results)
  - [Discussion](#discussion)
  - [Related Work](#related-work)
  - [Appendices](#appendices)
- [Common Pitfalls and How to Avoid Them](#common-pitfalls-and-how-to-avoid-them)
  - [Obsessing Over Publishability](#obsessing-over-publishability)
  - [Unnecessary Complexity and Verbosity](#unnecessary-complexity-and-verbosity)
  - [Not Prioritizing the Writing Process](#not-prioritizing-the-writing-process)
- [Tacit Knowledge and Beyond](#tacit-knowledge-and-beyond)
...
Another thorny question is: When should you stop doing research and start writing up your research? This is a hard and subtle question that is, in many ways, a matter of [research taste](https://www.lesswrong.com/posts/Ldrss6o3tiKT6NdMm/my-research-process-understanding-and-cultivating-research), but here is my general guide:
...
How to find out what came before? **Use a large language model**. If you're not already familiar with a relevant literature, LLMs are pretty great at doing quick literature reviews, e.g. [Gemini Deep Research](https://gemini.google/overview/deep-research/?hl=en-GB)[^4]. Reading the literature yourself is much better of course, but takes way, way longer and should have been done at the start project.
...
**A paper is worth little unless it can *convince***[^5] **the reader of its key claims**. To do this, you need evidence. In machine learning, this typically means experiments. Below, I discuss how I think about what good experimental evidence looks like—see [my research process sequence](https://www.lesswrong.com/posts/hjMy4ZxS5ogA9cTYK/how-i-think-about-my-research-process-explore-understand) for more advice.
...
I typically recommend that people switch from [understanding mode to distillation](https://www.lesswrong.com/posts/hjMy4ZxS5ogA9cTYK/how-i-think-about-my-research-process-explore-understand) and paper writing a month before a conference deadline, if at all possible. You should want to spend a lot of your time iterating on a write-up, getting feedback, trying to make it clearer, thinking about weaknesses, etc.
...
[^1]: Note: I am in no way claiming that *I* follow this advice, especially in blog posts—this is my attempt to paint a platonic ideal, and advise on how to be a better person than I. Personally, I find actually writing academic papers pretty frustrating and much prefer blog posts

[^2]: I think writing great papers certainly helps, and if you're new I recommend just trying to write the best paper you can, but there's still a lot of depressingly perverse incentives from ML peer review

[^3]: I mention this purely for completeness. I have never seen a convincing guarantee in deep learning, neural networks are far too squishy

[^4]: OpenAI's is also good, but Google's is free!

[^5]: Well, at least "provide enough evidence to somewhat update their beliefs", convince is a fairly high bar

[^6]: Which, admittedly, is fairly rare in ML as far as I'm aware

[^7]: Thanks to Paul Bogdan for these points on p-values

[^8]: Also the title, though I haven't figured out how to productively spend 20% of my time on that yet…

[^9]: Paper swaps are a great way to get feedback—find someone else also working on a paper and offer to give each other feedback. Even if you have less time before the paper deadline, this tends to be a mutually beneficial trade.

[^10]: This can be its own paragraph, or part of paragraph 3

[^11]: Save that for the related work section…

[^12]: If something is *super* widespread knowledge, no need to cover it, but err towards defining things. E.g. I wouldn't bother defining the transformer architecture or an LLM, but I would define a sparse autoencoder or steering vector

[^13]: If this is too long, you can move most of it to an appendix
